...
class RnnShoppingConfig():
    def __init__(self):
        ...
        self.save_path='../../res/rnn_shopping_predict.csv'
        self.emb_path="../../vocab/"
        ...
        # 训练设置
        self.batch_size=64
        self.padding_size=20 # 控制每句话的长度，不够的补足，太长的截断
        ...
        # 保存路径
        self.model_save_path='../../train/RNN_shopping.pt'
        self.log_path='../../train/log/RNN_shopping/'
        self.predict_save='../../res/RNN_shopping.csv'